...
NMDS_plot = 
  ...
  stat_ellipse(data = NMDS, aes(x = MDS.MDS1, y = MDS.MDS2, color = T.F), 
               linetype = "solid", show.legend = T) +
  scale_color_manual(values=c("#FF3399", "#117733", "#3366FF", "purple", "orange", "yellow")) +
  scale_fill_manual(values=c("#FF3399", "#117733", "#3366FF", "purple", "orange", "yellow")) +
  theme_classic() +
...
NMDS_plot = 
  ggplot() +
  geom_point(data = NMDS, aes(x = MDS.MDS1, y = MDS.MDS2, fill = T.F,
                              color = T.F, shape  = Treatment),
             alpha = 0.7, size = 3) +
  #geom_text(data = species.scores, aes(x = NMDS1, y = NMDS2, label = species)) +
  stat_ellipse(data = NMDS, aes(x = MDS.MDS1, y = MDS.MDS2, color = T.F), 
               linetype = "solid", show.legend = T) +
  scale_color_manual(name = "Treatments",
                     labels = c("No Seeding - No Burning", 
                                "No Seeding - Late-Spring Burning", 
                                "No Seeding - Winter Burning", 
                                "Seeding - No Burning",
                                "Seeding - Late-Spring Burning",
                                "Seeding - Winter Burning"),
    values=c("#FF3399", "#117733", "#3366FF", "purple", "orange", "yellow")) +
