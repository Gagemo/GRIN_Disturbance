...
Grass_Box = 
  ...
  geom_point(aes(fill=Treatment), 
             position = position_jitterdodge(), alpha = 0.5) +
  stat_pvalue_manual(tukey_Grass,hide.ns = T) +
...
Sedge_Box = 
  ...
  geom_point(aes(fill=Treatment), 
             position = position_jitterdodge(), alpha = 0.5) +
  stat_pvalue_manual(tukey_Sedge,
                     hide.ns = T)+
...
Woody_Box = 
  ...
  geom_point(aes(fill=Treatment), 
             position = position_jitterdodge(), alpha = 0.5) +
  stat_pvalue_manual(tukey_Woody,
                     hide.ns = T)+
...
Grass_Box = 
  ...
  geom_point(aes(fill=Treatment), 
             position = position_jitterdodge(), alpha = 0.5) +
  stat_pvalue_manual(tukey_Grass,
                     hide.ns = T)+
  labs(subtitle = get_test_label(anova_Grass,
                                 detailed = TRUE),
       caption = get_pwc_label(tukey_Grass)) +
  ...
  labs(x = "Treatment", y = "Total (%) Coverage", title = "Grass")
Grass_Box
ggsave("Figures/Chapter 1 - Soil Disturbance Seasonality/2022Grass_Box.png", 
       width = 10, height = 7)
...
Sedge_Box = 
  ...
  labs(x = "Treatment", y = "Total (%) Coverage", title = "Sedge")
Sedge_Box
ggsave("Figures/Chapter 1 - Soil Disturbance Seasonality/2022Sedge_Box.png", 
       width = 10, height = 7)
...
Woody_Box = 
  ...
  labs(x = "Treatment", y = "Total (%) Coverage", title = "Woody")
Woody_Box
ggsave("Figures/Chapter 1 - Soil Disturbance Seasonality/2022Woody_Box.png", 
       width = 10, height = 7)
